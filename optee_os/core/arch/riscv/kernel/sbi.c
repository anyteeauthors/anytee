...
void sdTZ_return_to_ree(unsigned long a0, unsigned long a1,
			unsigned long a2, unsigned long a3,
			unsigned long a4, unsigned long a5,
			unsigned long a6, unsigned long a7);

void __attribute__((__noreturn__)) sdTZ_return_to_ree(unsigned long a0, unsigned long a1,
			unsigned long a2, unsigned long a3,
			unsigned long a4, unsigned long a5,
			unsigned long a6, unsigned long a7)
{
	...
	if(res.a0 & OPTEE_SMC_FAST_CALL){
	    ...
	    thread_handle_std_smc(res.a0, res.a1, res.a2, res.a3,
...
void mu_service() {
    sdTZ_return_to_ree(TEESMC_OPTEED_FUNCID_RETURN_ENTRY_DONE, 0, 0, 0, 0, 0, 0, 0);
    while(1);
}
