...
/* __GNUC__ */
    ...
    printf("Step 2: call sgx_create_enclave to initialize an enclave instance\n");
    /* Step 2: call sgx_create_enclave to initialize an enclave instance */
    ...
    printf("step 3: save the launch token if it is updated\n");
...
int SGX_CDECL main(int argc, char *argv[])
{
    ...
    printf("Info: running enclave app\n");
    /* Initialize the enclave */
