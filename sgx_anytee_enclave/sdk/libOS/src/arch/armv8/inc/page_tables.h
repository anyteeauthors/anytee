...
#define L2_BLOCK_SIZE   0x00200000
...
#define PTE_ENH_WA_FLAGS   (PTE_ATTR(1) | PTE_nG | PTE_AP_RW_PRIV | PTE_SH_IS | PTE_AF)
#define PTE_ENH_nWA_FLAGS  (PTE_ATTR(1) | PTE_nG | PTE_AP_RO_PRIV | PTE_SH_IS | PTE_AF)
#define PTE_ENH_nA_FLAGS   (0)
